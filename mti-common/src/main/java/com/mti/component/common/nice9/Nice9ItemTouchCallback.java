 ...
 */
public class Nice9ItemTouchCallback extends ItemTouchHelper.Callback {

    private ItemTouchAdapter itemTouchAdapter;

    public Nice9ItemTouchCallback(ItemTouchAdapter itemTouchAdapter) {
    ...
    public Nice9ItemTouchCallback setOnDragListener(OnDragListener onDragListener) {
