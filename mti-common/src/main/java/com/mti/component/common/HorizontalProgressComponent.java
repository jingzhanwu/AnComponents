 ...
 * 支持二级，三级进度
 **/
public class HorizontalProgressComponent extends View {
    ...
    public interface OnProgressChangedListener {
        void onProgressChanged(HorizontalProgressComponent progressBar, int max, int progress);

        void onSecondProgressChanged(HorizontalProgressComponent progressBar, int max, int progress);
    }

    public HorizontalProgressComponent(Context context) {
        super(context);
        init(context, null);
    }

    public HorizontalProgressComponent(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public HorizontalProgressComponent(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.HorizontalProgressComponent);
        max = a.getInteger(R.styleable.HorizontalProgressComponent_zpb_max, 100);
        progress = a.getInteger(R.styleable.HorizontalProgressComponent_zpb_progress, 0);
        bgColor = a.getColor(R.styleable.HorizontalProgressComponent_zpb_bg_color, 0xff3F51B5);
        progressColor = a.getColor(R.styleable.HorizontalProgressComponent_zpb_pb_color, 0xffFF4081);
        secondProgressColor = a.getColor(R.styleable.HorizontalProgressComponent_zpb_second_pb_color, 0xffFF4081);
        padding = a.getDimensionPixelSize(R.styleable.HorizontalProgressComponent_zpb_padding, 0);
        showZeroPoint = a.getBoolean(R.styleable.HorizontalProgressComponent_zpb_show_zero_point, false);
        showSecondProgress = a.getBoolean(R.styleable.HorizontalProgressComponent_zpb_show_second_progress, false);
        secondProgress = a.getInteger(R.styleable.HorizontalProgressComponent_zpb_second_progress, 0);
        secondProgressShape = a.getInteger(R.styleable.HorizontalProgressComponent_zpb_show_second_point_shape, 0);
        openGradient = a.getBoolean(R.styleable.HorizontalProgressComponent_zpb_open_gradient, false);
        gradientFrom = a.getColor(R.styleable.HorizontalProgressComponent_zpb_gradient_from, 0xffFF4081);
        gradientTo = a.getColor(R.styleable.HorizontalProgressComponent_zpb_gradient_to, 0xffFF4081);
        openSecondGradient = a.getBoolean(R.styleable.HorizontalProgressComponent_zpb_open_second_gradient, false);
        showMode = a.getInt(R.styleable.HorizontalProgressComponent_zpb_show_mode, 0);
        secondGradientFrom = a.getColor(R.styleable.HorizontalProgressComponent_zpb_second_gradient_from, 0xffFF4081);
        secondGradientTo = a.getColor(R.styleable.HorizontalProgressComponent_zpb_second_gradient_to, 0xffFF4081);
        radius = a.getDimensionPixelSize(R.styleable.HorizontalProgressComponent_zpb_round_rect_radius, 20);
        drawBorder = a.getBoolean(R.styleable.HorizontalProgressComponent_zpb_draw_border, false);
        borderWidth = a.getDimensionPixelSize(R.styleable.HorizontalProgressComponent_zpb_border_width, 1);
        borderColor = a.getColor(R.styleable.HorizontalProgressComponent_zpb_border_color, 0xffff001f);
        a.recycle();
    }
