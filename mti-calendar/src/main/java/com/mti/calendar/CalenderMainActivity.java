...
import com.mti.calendar.custom.CustomActivityCalender;
import com.mti.calendar.full.FullActivityCalender;
import com.mti.calendar.index.IndexActivityCalender;
import com.mti.calendar.meizu.MeiZuActivityCalender;
import com.mti.calendar.meizu.MeiZuMonthView;
import com.mti.calendar.meizu.MeizuWeekView;
import com.mti.calendar.multi.MultiActivityCalender;
import com.mti.calendar.pager.ViewPagerActivityCalender;
import com.mti.calendar.progress.ProgressActivityCalender;
import com.mti.calendar.range.RangeActivityCalender;
import com.mti.calendar.simple.SimpleActivityCalender;
import com.mti.calendar.single.SingleActivityCalender;
import com.mti.calendar.solay.SolarActivityCalender;

import java.util.HashMap;
import java.util.List;
import java.util.Map;

public class CalenderMainActivity extends CalenderBaseActivity implements
    ...
    protected void initView() {
        ...
        findViewById(R.id.iv_more).setOnClickListener(v -> {
            if (mMoreDialog == null) {
                mMoreDialog = new AlertDialog.Builder(CalenderMainActivity.this)
                        .setTitle(R.string.list_dialog_title)
                        .setItems(R.array.list_dialog_items, CalenderMainActivity.this)
                        .create();
            }
            mMoreDialog.show();
        });
...
//                                        mCalendarView.getCurYear(), mCalendarView.getCurMonth(), 23);
                        ...
                        case 6:
                            ...
                            new AlertDialog.Builder(CalenderMainActivity.this)
        ...
        findViewById(R.id.iv_func).setOnClickListener(v -> {
            if (mFuncDialog == null) {
                mFuncDialog = new AlertDialog.Builder(CalenderMainActivity.this)
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.ll_flyme) {
            ...
            CustomActivityCalender.show(this);
        } else if (id == R.id.ll_full) {
            FullActivityCalender.show(this);
        } else if (id == R.id.ll_range) {
            RangeActivityCalender.show(this);
            ...
            ViewPagerActivityCalender.show(this);
        } else if (id == R.id.ll_single) {
            SingleActivityCalender.show(this);
        } else if (id == R.id.ll_multi) {
            MultiActivityCalender.show(this);
        } else if (id == R.id.ll_solar_system) {
            SolarActivityCalender.show(this);
        } else if (id == R.id.ll_progress) {
            ProgressActivityCalender.show(this);
        }
    }
