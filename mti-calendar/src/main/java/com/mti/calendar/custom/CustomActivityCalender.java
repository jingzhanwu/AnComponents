package com.mti.calendar.custom;
...
public class CustomActivityCalender extends CalenderBaseActivity implements
    ...
    public static void show(Context context) {
        context.startActivity(new Intent(context, CustomActivityCalender.class));
    }
