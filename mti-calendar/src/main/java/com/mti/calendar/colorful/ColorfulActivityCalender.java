package com.mti.calendar.colorful;
...
public class ColorfulActivityCalender extends CalenderBaseActivity implements
    ...
    public static void show(Context context) {
        context.startActivity(new Intent(context, ColorfulActivityCalender.class));
    }
