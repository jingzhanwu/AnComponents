...
import com.mti.calendar.base.fragment.FragmentAdapter;
...
public class ViewPagerActivityCalender extends CalenderBaseActivity implements
    ...
    public static void show(Context context) {
        context.startActivity(new Intent(context, ViewPagerActivityCalender.class));
    }
    ...
    protected void initView() {
        ...
        fragments.add(PagerFragmentCalendar.newInstance());
        fragments.add(PagerFragmentCalendar.newInstance());
        fragments.add(PagerFragmentCalendar.newInstance());
