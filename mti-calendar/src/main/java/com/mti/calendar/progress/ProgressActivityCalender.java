package com.mti.calendar.progress;
...
public class ProgressActivityCalender extends CalenderBaseActivity implements
    ...
    public static void show(Context context) {
        context.startActivity(new Intent(context, ProgressActivityCalender.class));
    }
