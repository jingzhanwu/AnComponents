package com.mti.calendar.single;
...
public class SingleActivityCalender extends CalenderBaseActivity implements
    ...
    public static void show(Context context) {
        context.startActivity(new Intent(context, SingleActivityCalender.class));
    }
