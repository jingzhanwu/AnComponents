package com.mti.calendar.solay;
...
public class SolarActivityCalender extends CalenderBaseActivity implements
    ...
    public static void show(Context context) {
        context.startActivity(new Intent(context, SolarActivityCalender.class));
    }
