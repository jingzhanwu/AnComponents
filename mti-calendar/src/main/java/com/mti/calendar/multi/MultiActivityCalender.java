package com.mti.calendar.multi;
...
public class MultiActivityCalender extends CalenderBaseActivity implements
    ...
    public static void show(Context context) {
        context.startActivity(new Intent(context, MultiActivityCalender.class));
    }
