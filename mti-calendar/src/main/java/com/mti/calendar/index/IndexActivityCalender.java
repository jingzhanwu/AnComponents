package com.mti.calendar.index;
...
public class IndexActivityCalender extends CalenderBaseActivity implements
    ...
    public static void show(Context context) {
        context.startActivity(new Intent(context, IndexActivityCalender.class));
    }
