package com.mti.component.extend.floatbutton;
...
import com.mti.component.extend.R;
...
public class FloatingActionsMenu extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        mIcon = attr.getResourceId(R.styleable.FloatingActionsMenu_fab_original_icon, R.drawable.fab_menu);
    ...
    private void createAddButton(Context context, int mIcon) {
        mAddButton = new AddFloatingActionButton(context, mIcon) {
            @Override
        ...
        mAddButton.setScaleType(ImageView.ScaleType.FIT_XY);
